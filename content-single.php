	...
	<footer class="entry-meta">
		...
		<?php  $custom = get_post_custom($post->ID); ?>
			...
			<dl class="dl-horizontal">
			  ...
			  <dd><?php  the_terms( $post->ID, 'movie_countries', ' ', ' / ' ); ?></dd>
			  <dt><?php echo __( 'Genre' ) ?></dt>
			  <dd><?php  the_terms( $post->ID, 'movie_genres', ' ', ' / ' ); ?></dd>
			  <dt><?php echo __( 'Ticket Price' ) ?></dt>
			  <dd><?php  echo $custom["ticket_price"][0]; ?></dd>
			  <dt><?php echo __( 'Release Date' ) ?></dt>
			  <dd><?php  echo $custom["release_date"][0]; ?></dd>
			</dl>
